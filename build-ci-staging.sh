...
mvn -B -s settings.xml -Ddeployment -Dorg.slf4j.simpleLogger.log.org.apache.maven.cli.transfer.Slf4jMavenTransferListener=warn -Drelease.type=rcs clean install && mvn -B -s settings.xml -Ddeployment -Dorg.slf4j.simpleLogger.log.org.apache.maven.cli.transfer.Slf4jMavenTransferListener=warn -Drelease.type=rcs site-deploy
