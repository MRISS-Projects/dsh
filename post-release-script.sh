...
then
    ...
    mvn -B -s ../../settings.xml -Dorg.slf4j.simpleLogger.log.org.apache.maven.cli.transfer.Slf4jMavenTransferListener=warn -Dproduct-release-deployment -Ddeployment -Drelease-deployment site-deploy
    mvn -B -N -s ../../settings.xml -Dorg.slf4j.simpleLogger.log.org.apache.maven.cli.transfer.Slf4jMavenTransferListener=warn -Dbranch.name=master -Dupdate-readme process-resources
